...
public class Launcher {
    ...
    private static void writeAgentIni(String sourcePluginStr) throws Exception {
    ...
    public static void main(String[] args) {
        //args[1] should be the name of the test class
        if (args[1] != null) {
            try {
                //get an instance of the PluginTestCase
                PluginTestCase tpc = (PluginTestCase)Class.forName(args[1]).newInstance();
