...
/** Additional methods for SkillsPG
...
public interface NewSkillsPG extends SkillsPG, NewPropertyGroup, org.cougaar.planning.ldm.dq.HasDataQuality {
  void setYearsExperience(int yearsExperience);
  void setSLOCPerDay(int SLOCPerDay);
}
